...
"    highp float NdotN1    = max(dot(normals, normals1), 0.0);                                                                                     \n"
"    highp float NdotN2    = max(dot(normals, normals2), 0.0);                                                                                     \n"
"    highp float NdotN3    = max(dot(normals, normals3), 0.0);                                                                                     \n"
"    highp float NdotN4    = max(dot(normals, normals4), 0.0);                                                                                     \n"


"    highp float distance  =  length(depth - depth1);                                                                         \n"
"    originalPixel         =  originalPixel * NdotN1 + distance* 10.0;                                                                                         \n"

"    distance              =  length(depth - depth2);                                                                         \n"
"    originalPixel         =  originalPixel * NdotN2 + distance* 10.0;                                                                                         \n"

"    distance              =  length(depth - depth3);                                                                         \n"
"    originalPixel         =  originalPixel * NdotN3 + distance* 10.0;                                                                                         \n"

"    distance              =  length(depth - depth4);                                                                         \n"
"    originalPixel         =  originalPixel * NdotN4 + distance* 10.0;                                                                                         \n"
